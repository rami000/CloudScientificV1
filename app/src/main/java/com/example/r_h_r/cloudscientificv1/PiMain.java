package com.example.r_h_r.cloudscientificv1;
...
public class PiMain extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pi_main);
    ...
    public void onPause() {
        super.onPause();
        //Pausing can be the end of an sapp if the device kills it or the user doesn't open it again
